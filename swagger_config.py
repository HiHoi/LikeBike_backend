...
COURSE_RECOMMENDATION_MODEL = {
    ...
    "properties": {
        "id": {"type": "integer", "example": 1},
        "user_id": {"type": "integer", "example": 1},
        "location_name": {"type": "string", "example": "한강공원"},
        "photo_url": {"type": "string", "example": "https://example.com/photo.jpg"},
        "review": {"type": "string", "example": "아름다운 코스입니다."},
        "status": {"type": "string", "example": "pending"},
        "points_awarded": {"type": "integer", "example": 0},
        "reviewed_by_admin_id": {"type": "integer", "example": 2},
        "reviewed_at": {
            "type": "string",
            "format": "date-time",
